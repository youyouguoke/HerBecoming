...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "hero.free": "10 free questions every day. No sign-up required.",
    ...
    "chat.limit_reached_body":
      "You have used your 10 free questions today. Sign in to keep exploring your thoughts with HerBecoming.",
